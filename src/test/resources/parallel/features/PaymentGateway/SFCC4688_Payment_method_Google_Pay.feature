Feature: PaymentGateWay_Payment method Google Pay

#  Background:
#    Given the user opens URL
#    And the user launches the RAC home page

  #@SFCC374 @SFCC4688 @TC_SFCC4200 @smoke @regression @PaymentGateWay
  Scenario Outline: Verify Google payment type
