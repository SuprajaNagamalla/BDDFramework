Feature: PaymentGateWay_Payment method Credit Card
...
#    And the user launches the RAC home page
  ...
  #@SFCC374 @SFCC4694 @TC_SFCC4196 @smoke @regression @PaymentGateWay
  Scenario Outline: Verify credit card payment type
    ...
    #And the user saves credit or debit card credentials from "<SheetName>" at row <RowNumber>
